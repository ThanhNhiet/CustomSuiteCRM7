...
<div id="rc_modal" style="display:none; position:fixed; z-index:9999; left:0; top:0; width:100%; height:100%; overflow:auto; background-color:rgba(0,0,0,0.4);">
    <div style="background-color:#fefefe; margin: 2% auto; padding:0; border:1px solid #888; width:60%; height: 90vh; border-radius: 5px; display: flex; flex-direction: column; box-shadow: 0 4px 15px 0 rgba(0,0,0,0.3);">
