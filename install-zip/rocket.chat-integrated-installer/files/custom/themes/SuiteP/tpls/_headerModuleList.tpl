        ...
        <div class="mobile-bar">
            <ul id="toolbar" class="toolbar">
                ...
                <li id="rocket_chat_header_btn" class="dropdown nav navbar-nav">
                     <button onclick="openRocketChatModal('${rc_website}/directory/channels?layout=embedded'); return false;" title="Rocket.Chat" style="background: transparent; border: none; padding: 5px;">
